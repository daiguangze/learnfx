...
type FilterVisibleItemsReq struct {
	...
	ItemIDs []int64 `thrift:"ItemIDs,2,required" frugal:"2,required,list<i64>" json:"ItemIDs"`
}
...
func (p *FilterVisibleItemsReq) InitDefault() {
}
...
type FilterVisibleItemsResp struct {
	VisibleItemIDs []int64 `thrift:"VisibleItemIDs,1,required" frugal:"1,required,list<i64>" json:"VisibleItemIDs"`
}
...
func (p *FilterVisibleItemsResp) InitDefault() {
}
...
type Item struct {
	...
	VisibleUsers []int64 `thrift:"VisibleUsers,4,required" frugal:"4,required,list<i64>" json:"VisibleUsers"`
}
...
func (p *LearnFxServiceCreateItemArgs) InitDefault() {
}
...
func (p *LearnFxServiceCreateItemResult) InitDefault() {
}
...
type LearnFxServiceFilterVisibleItemsArgs struct {
	Req *FilterVisibleItemsReq `thrift:"req,1" frugal:"1,default,FilterVisibleItemsReq" json:"req"`
}
...
func (p *LearnFxServiceFilterVisibleItemsArgs) InitDefault() {
}
...
type LearnFxServiceFilterVisibleItemsResult struct {
	Success *FilterVisibleItemsResp `thrift:"success,0,optional" frugal:"0,optional,FilterVisibleItemsResp" json:"success,omitempty"`
}
...
func (p *LearnFxServiceFilterVisibleItemsResult) InitDefault() {
}
